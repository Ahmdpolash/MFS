...
import { SendMoney } from "@/components/dashboard/user/sent-money";
import { TransactionForm } from "@/components/dashboard/user/transactionForm";
import ConfirmPage from "@/components/dashboard/user/confirmPage";
